...
![启动Flask](../../Images/Docker/Docker入坑系列/构建镜像及容器编排/启动Flask.png)

然后，我们在浏览器中输入[http://localhost:5000](http://localhost:5000)就能看到熟悉的hello world。

![helloworld](../../Images/Docker/Docker入坑系列/构建镜像及容器编排/helloworld.png)
...
![镜像文件信息](../../Images/Docker/Docker入坑系列/构建镜像及容器编排/镜像文件信息.png)
...
![累计访问界面](../../Images/Docker/Docker入坑系列/构建镜像及容器编排/累计访问界面.png)

使用`docker ps`，我们也可以看到两个被启动的容器。

![容器编排](../../Images/Docker/Docker入坑系列/构建镜像及容器编排/容器编排.png)
